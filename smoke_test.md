...
java "-javaagent:target/requestlens-agent-0.1.7-SNAPSHOT.jar=config=.\requestlens-agent.yaml" -jar demo/target/profiler-demo-app.jar --server.port=8080
```
...
```powershell
$token = "dev-token-123456789"
java "-javaagent:target/requestlens-agent-0.1.7-SNAPSHOT.jar=port=7099,auth.token=$token,trace.enabled=true,trace.packages=demo,trace.sample.rate=1,profiler.persistence.enabled=true,profiler.persistence.path=target/smoke-profiler.db" -jar demo/target/profiler-demo-app.jar --server.port=8080
```
...
```powershell
java "-javaagent:target/requestlens-agent-0.1.7-SNAPSHOT.jar=port=7100,auth.token=$token,trace.enabled=true,trace.packages=demo,trace.sample.rate=1" -jar demo/target/profiler-demo-app.jar --server.port=8080
```
...
```powershell
java "-javaagent:target/requestlens-agent-0.1.7-SNAPSHOT.jar=port=7099,auth.token=$token,trace.enabled=true,trace.packages=demo,trace.sample.rate=1" -jar demo/target/profiler-demo-app.jar --server.port=8081
```
